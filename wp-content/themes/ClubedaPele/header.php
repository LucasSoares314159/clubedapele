...
<header class="masthead">
	<!-- Web -->
	<div class="img-header d-none d-sm-block d-sm-none d-md-block">
		<img class="animated fadeInDown delay-1s" src="<?php bloginfo("template_url");?>/img/logo-header.png?>" width="500" height="358">
	</div>

	<!-- Mobile -->
	<div class="img-header-mob d-block d-sm-none d-none d-sm-block d-md-none">
		<img class="animated fadeInDown delay-1s" src="<?php bloginfo("template_url");?>/img/logo-header.png?>" width="300" height="215">
	</div>
</header>
